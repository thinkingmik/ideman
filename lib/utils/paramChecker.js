...
var checkParamMixed = function (param, nullable, regexp) {
  ...
  if (nullable === true && validator.isNull(text)) {
    return null;
  }
  if ((nullable === false && validator.isNull(text)) || !validator.matches(text, pattern)) {
...
var checkParamBool = function (param, nullable) {
  ...
  if ((nullable === false && validator.isNull(text)) || !validator.isBoolean(text)) {
...
var checkParamInt = function (param, nullable) {
  ...
  if ((nullable === false && validator.isNull(text)) || !validator.isInt(text)) {
...
var checkParamEmail = function (param, nullable) {
  ...
  if ((nullable === false && validator.isNull(text)) || !validator.isEmail(text)) {
...
var checkParamDomain = function (param, nullable) {
  ...
  if ((nullable === false && validator.isNull(text)) || !validator.isFQDN(text, options)) {
...
var checkParamDate = function (param, nullable) {
  ...
  if ((nullable === false && validator.isNull(text)) || !validator.isDate(text)) {
...
var checkParamText = function (param, nullable) {
  ...
  if ((nullable === false && validator.isNull(text))) {
...
var checkParamUsername = function (param, nullable) {
  ...
  if ((nullable === false && validator.isNull(text)) || !(validator.matches(text, pattern) || checkParamEmail(text, nullable))) {
